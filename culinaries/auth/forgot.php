    ...
    <div class="row justify-content-center align-items-center text-center p-2">
      <div class="m-1 col-sm-8 col-md-6 col-lg-4 shadow-sm p-3 mb-5 bg-white border rounded">
        <div class="pt-5 pb-5">
          ...
          <p class="text-center text-uppercase mt-3">Forgot Password</p>
          
          <?php if($_GET['errors'] == 'errors'): ?>
            <div class="alert alert-danger alert-dismissible fade show" role="alert">
              <strong>Failed!</strong> your username is not registered!.
          ...
          <form class="form text-center" action="./../app/auth/forgot.php" method="POST">
            ...
            <button class="btn btn-lg btn-block btn-primary mt-4" name="btn-submit" type="submit">Check Account</button>
