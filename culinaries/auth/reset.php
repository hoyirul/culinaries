    ...
    <div class="row justify-content-center align-items-center text-center p-2">
      <div class="m-1 col-sm-8 col-md-6 col-lg-4 shadow-sm p-3 mb-5 bg-white border rounded">
        <div class="pt-5 pb-5">
          ...
          <form class="form text-center" action="./../app/auth/reset.php" method="POST">
            <input type="hidden" name="token" value="<?= $_GET['token'] ?>">

            <div class="form-group input-group-md">
              <input type="password" class="form-control" minlength="6" required name="password" id="password" placeholder="Password">
              <!--<div class="invalid-feedback">
                Errors in password during form validation, also add .is-invalid class to the input fields
              </div> -->
            </div>
            <div class="form-group input-group-md">
              <input type="password" class="form-control" minlength="6" required name="confirm" id="password" placeholder="Confirm Password">
              <!--<div class="invalid-feedback">
                Errors in password during form validation, also add .is-invalid class to the input fields
              </div> -->
            </div>
            <button class="btn btn-lg btn-block btn-primary mt-4" name="btn-submit" type="submit">Submit</button>
            <a href="./auth.php" class="float-right mt-2">Back to login? </a>
          </form>
        </div>
